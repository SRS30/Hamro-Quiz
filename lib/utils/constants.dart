...
final String appName = "Hamro Quiz";
final String packageName = "com.srs.hamroquiz";
...
final String initialSelectedCountryCode = 'NP';
...
final String databaseUrl = "https://admin.hamroquiz.com";
...
final int questionDurationInSeconds = 18;
final int selfChallengeMaxMinutes = 45;
...
final String initialCountryCode = "NP"; // change your initialCountry Code

//Currency in which admin want to give money to user
final String payoutRequestCurrency = '\ NP';
...
final List<PayoutMethod> payoutMethods = [
  ...
  PayoutMethod(
      ...
      inputDetailsFromUser: [
        "Enter Esewa id",
      ], image: "assets/images/esewa.svg", type: "Esewa"),
  ...
  PayoutMethod(
      ...
      image: "assets/images/khalti.svg",
      type: "Khalti"),
  ...
  PayoutMethod(
      ...
      inputDetailsFromUser: [
        "Enter IME id",
      ], image: "assets/images/ime.svg", type: "IME Pay"),
