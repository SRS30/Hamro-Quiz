              ...
              ? (hasMore && index == (leaderBoardList.length - 1))
                  ...
                  : Column(
                    children: [
                      ...
                      index == (leaderBoardList.length - 1)?Container():Container(
                        margin: EdgeInsets.only(bottom: 5,top: 5,left: MediaQuery.of(context).size.width*0.03,right: MediaQuery.of(context).size.width*0.05),
                        width: MediaQuery.of(context).size.width,
                        height: 0.2,
                        color: Theme.of(context).colorScheme.secondary,
                      )
