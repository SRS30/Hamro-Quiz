...
import '../profile/widgets/themeDialog.dart';
                  ...
                  Align(
                    ...
                    child: Transform.scale(
                        ...
                        child: SvgPicture.asset(
                            "assets/images/selfchallenge_icon.svg",color: Theme.of(context).primaryColor,),
                    ),
                  ),
                ],
              ),
          ...
          children: [
            ...
            Container(
              ...
              child: IconButton(
                ...
                icon: Icon(Icons.play_arrow_outlined, color: Theme.of(context).primaryColor,),
              ),
            ),
            SizedBox(
              width: 12.5,
                ...
                onPressed: () {
                  Future.delayed(
                      const Duration(seconds: 0),
                          () => showDialog(
                        context: context,
                        builder: (context) =>  LanguageDailogContainer(),
                      ));
                },
                icon: SvgPicture.asset(
            ...
            Container(
              ...
              child: IconButton(
                ...
                icon: SvgPicture.asset(
                  UiUtils.getImagePath("theme.svg"),
                  color: Theme.of(context).primaryColor,
                ),
              ),
            ),
